...
//自定义一个比较器    实现接口Comparator  重写接口的方法compare
class MyComparator implements Comparator<Emp>{

	@Override
	public int compare(Emp o1, Emp o2) {
		return o1.salary - o2.salary;   //比较工资
	}
...
public class Demo6 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//无法进行自然排序的键需要自己定义一个排序规则
		//1.重写compareTo 方法  2.自定义个类   自定义一个比较器
		TreeMap<Emp, String> tree = new TreeMap<Emp, String>(comparator);
		tree.put(new Emp("zhangsan", 2000),"001");
		tree.put(new Emp("lisi", 1000),"002");
		tree.put(new Emp("wangwu", 3000),"003");
		tree.put(new Emp("zhaoliu", 5000),"005");
		
		tree.put(new Emp("tom", 5000),"008");
		System.out.println(tree);
