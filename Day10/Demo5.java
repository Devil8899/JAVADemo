 ...
 class person
{
	...
	public void eat(){
	  ...
	  new father(){    
		 ...
		 public void print(){    //子类都有方法
		  System.out.println("jskdfjk");
		 }
	  }.print();
     //2.也可以多态来调用  但是如果子类的方法是独有的 无法强制转换 只能通过局部类来实现
	  ...
	  father ft=new father(){
		  ...
		  //这个写法不行 因为匿名内部类是一个子类对象，当用father的ft引用指向时，就被提升为了father类型，而编译时检查father类中是否有print2方法，所以编译失败
		  /*public void print2(){
            System.out.println("多态  不能调用 子类特有方法");
		  }*/
	  };
