...
------------| FileInputStream  读取文件数据的输入字节流   一般会用缓冲数组 第四种来读取数据 效率较高
...
//		readTest3();
	...
	public static void readTest2() throws IOException {
		...
		System.out.println("用时秒数" + new Date(endTime - startTime).getSeconds());
	...
	//方式4：使用缓冲数组配合循环一起读取。28
		public static void readTest4() throws IOException{
			...
			byte[] buf = new byte[1024];
			//存储读取到的数据    缓冲数组 的长度一般是1024的倍数，  1024 1kb
